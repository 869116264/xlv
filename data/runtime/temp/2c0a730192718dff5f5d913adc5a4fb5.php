<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:44:"themes/admin_simpleboot3/data/libao/add.html";i:1531193384;s:97:"/Applications/XAMPP/xamppfiles/htdocs/thinkcmf/public/themes/admin_simpleboot3/public/header.html";i:1525682252;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<div class="wrap">
    ...
    <form method="post" class="form-horizontal js-ajax-form margin-top-20" action="<?php echo url('menu/addPost'); ?>">
        <div class="form-group">
            <label for="input-parent_id" class="col-sm-2 control-label"><span class="form-required">*</span>数量</label>
