<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:44:"themes/admin_simpleboot3/data/data/base.html";i:1526278281;s:97:"/Applications/XAMPP/xamppfiles/htdocs/thinkcmf/public/themes/admin_simpleboot3/public/header.html";i:1525682252;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
    ...
    <form class="js-ajax-form" action="" method="post">
        <table class="table table-hover table-bordered table-list">
            ...
            <tr>
                ...
                <th width="20">ID</th>
                <th width="60">日期</th>
                <th width="60">总注册用户数</th>
                <th width="60">日新增用户数</th>
                <th width="60">日活跃用户数</th>
                <th width="80">当天最高在线人数</th>
                <th width="80">当天平均在线人数</th>
                <th width="90">心跳用户人均在线时长</th>
                <th width="90">心跳活跃用户数字</th>
            </tr>
            </thead>
