<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:44:"themes/admin_simpleboot3/data/data/bean.html";i:1529916285;s:97:"/Applications/XAMPP/xamppfiles/htdocs/thinkcmf/public/themes/admin_simpleboot3/public/header.html";i:1525682252;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
    ...
    <form class="js-ajax-form" action="" method="post">
        <table class="table table-hover table-bordered table-list">
            ...
            <tr>
                ...
                <?php endif; ?>
                <th width="60">日期</th>
                <th width="60">奇异豆获得总额</th>
                <th width="60">奇异豆消耗总额</th>
                <th width="60">活跃用户的奇异豆存量总额</th>
            </tr>
            </thead>
            <?php if(is_array($data) || $data instanceof \think\Collection || $data instanceof \think\Paginator): if( count($data)==0 ) : echo "" ;else: foreach($data as $key=>$vo): ?>
                <tr>
                    <td><b><?php echo $vo['date']; ?></b></td>
                    <td><b><?php echo $vo['remain_money']; ?></b></td>
                    <td><b><?php echo $vo['increase_num']; ?></b></td>
                    <td><b><?php echo $vo['decrease_num']; ?></b></td>
                </tr>
