<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:46:"themes/admin_simpleboot3/data/data/remain.html";i:1526266780;s:97:"/Applications/XAMPP/xamppfiles/htdocs/thinkcmf/public/themes/admin_simpleboot3/public/header.html";i:1525682252;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
    ...
    <form class="js-ajax-form" action="" method="post">
        <table class="table table-hover table-bordered table-list">
            ...
            <tr>
                ...
                <th width="50">login_date</th>
                <th width="50">remain_day</th>
                <th width="65">num</th>
            </tr>
            </thead>
            <?php if(is_array($data) || $data instanceof \think\Collection || $data instanceof \think\Paginator): if( count($data)==0 ) : echo "" ;else: foreach($data as $key=>$vo): ?>
                <tr>
                    ...
                    <td><b><?php echo $vo['reg_date']; ?></b></td>
                    <td><b><?php echo $vo['login_date']; ?></b></td>
                    <td><b><?php echo $vo['remain_day']; ?></b></td>
                    <td><b><?php echo $vo['num']; ?></b></td>
                </tr>
