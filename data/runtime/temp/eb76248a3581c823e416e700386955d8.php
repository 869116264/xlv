<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:46:"themes/admin_simpleboot3/data/data/travel.html";i:1529915882;s:97:"/Applications/XAMPP/xamppfiles/htdocs/thinkcmf/public/themes/admin_simpleboot3/public/header.html";i:1525682252;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
    ...
    <form class="js-ajax-form" action="" method="post">
        <table class="table table-hover table-bordered table-list">
            ...
            <tr>
                ...
                <th width="60">日期</th>
                <th width="60">旅行次数</th>
                <th width="60">旅行用户数</th>
            </tr>
            </thead>
            <?php if(is_array($data) || $data instanceof \think\Collection || $data instanceof \think\Paginator): if( count($data)==0 ) : echo "" ;else: foreach($data as $key=>$vo): ?>
                <tr>
                    <td><b><?php echo $vo['date']; ?></b></td>
                    <td><b><?php echo $vo['travel_num']; ?></b></td>
                    <td><b><?php echo $vo['travel_user_num']; ?></b></td>
                </tr>
